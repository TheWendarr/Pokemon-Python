...
ITEMS = {
    ...
    # Phase B new held items
    "rocky-helmet": {"name": "Rocky Helmet", "category": "held"},
    "assault-vest": {"name": "Assault Vest", "category": "held"},
    "eviolite": {"name": "Eviolite", "category": "held"},
    "flame-orb": {"name": "Flame Orb", "category": "held"},
    "toxic-orb": {"name": "Toxic Orb", "category": "held"},
    "expert-belt": {"name": "Expert Belt", "category": "held"},
    "charcoal": {"name": "Charcoal", "category": "held"},
    "fire-gem": {"name": "Fire Gem", "category": "held"},
    "chesto-berry": {"name": "Chesto Berry", "category": "held"},
    "pecha-berry": {"name": "Pecha Berry", "category": "held"},
    "rawst-berry": {"name": "Rawst Berry", "category": "held"},
    "aspear-berry": {"name": "Aspear Berry", "category": "held"},
    "persim-berry": {"name": "Persim Berry", "category": "held"},
...
MOVES = {
    ...
    # Phase B moves
    "bite": _mv("bite", "dark", "physical", 60, 100, 25,
                flags=("contact", "protect"), flinch_chance=30, kind="damage"),
    "ice-punch": _mv("ice-punch", "ice", "physical", 75, 100, 15,
                     flags=("contact", "protect", "punch"), kind="damage+ailment",
                     ailment="freeze", ailment_chance=10),
    "close-combat": _mv("close-combat", "fighting", "physical", 120, 100, 5,
                        flags=("contact", "protect"), kind="damage+lower",
                        stat_changes=[{"stat": "defense", "change": -1},
                                      {"stat": "special_defense", "change": -1}]),
    "calm-mind": _mv("calm-mind", "psychic", "status", None, None, 20,
                     target="user", kind="net-good-stats",
                     stat_changes=[{"stat": "special_attack", "change": 1},
                                   {"stat": "special_defense", "change": 1}]),
    "destiny-bond": _mv("destiny-bond", "ghost", "status", None, None, 5,
                        target="user", kind="unique"),
    "perish-song": _mv("perish-song", "normal", "status", None, None, 5,
                       target="user", kind="unique"),
    "yawn": _mv("yawn", "normal", "status", None, 100, 10, kind="unique"),
    "transform": _mv("transform", "normal", "status", None, None, 10,
                     target="user", kind="unique"),
    "metronome": _mv("metronome", "normal", "status", None, None, 10,
                     target="user", kind="unique"),
    "guard-swap": _mv("guard-swap", "psychic", "status", None, None, 10,
                      kind="unique"),
    "power-swap": _mv("power-swap", "psychic", "status", None, None, 10,
                      kind="unique"),
    "magnet-rise": _mv("magnet-rise", "electric", "status", None, None, 10,
                       target="user", kind="unique"),
    "grudge": _mv("grudge", "ghost", "status", None, None, 5,
                  target="user", kind="unique"),
    "acupressure": _mv("acupressure", "normal", "status", None, None, 30,
                       kind="unique"),
    "nightmare": _mv("nightmare", "ghost", "status", None, 100, 15,
                     kind="unique"),
    "snatch": _mv("snatch", "dark", "status", None, None, 10,
                  target="user", kind="unique"),
    "rock-smash": _mv("rock-smash", "fighting", "physical", 40, 100, 15,
                      flags=("contact", "protect"), kind="damage+lower",
                      stat_changes=[{"stat": "defense", "change": -1}],
                      stat_chance=50),
    "iron-head": _mv("iron-head", "steel", "physical", 80, 100, 15,
                     flags=("contact", "protect"), flinch_chance=30),
    "air-slash": _mv("air-slash", "flying", "special", 75, 95, 15,
                     flags=("protect",), flinch_chance=30),
    "power-gem": _mv("power-gem", "rock", "special", 80, 100, 20,
                     flags=("protect",)),
    "dark-pulse": _mv("dark-pulse", "dark", "special", 80, 100, 15,
                      flags=("protect",), flinch_chance=20),
    "shadow-ball": _mv("shadow-ball", "ghost", "special", 80, 100, 15,
                       flags=("protect",), kind="damage+lower",
                       stat_changes=[{"stat": "special_defense", "change": -1}],
                       stat_chance=20),
    "flamethrower": _mv("flamethrower", "fire", "special", 95, 100, 15,
                        flags=("protect",), kind="damage+ailment",
                        ailment="burn", ailment_chance=10),
    "ice-beam": _mv("ice-beam", "ice", "special", 95, 100, 10,
                    flags=("protect",), kind="damage+ailment",
                    ailment="freeze", ailment_chance=10),
    "crunch": _mv("crunch", "dark", "physical", 80, 100, 15,
                  flags=("contact", "protect"), kind="damage+lower",
                  stat_changes=[{"stat": "defense", "change": -1}],
                  stat_chance=20),
    "focus-blast": _mv("focus-blast", "fighting", "special", 120, 70, 5,
                       flags=("protect",), kind="damage+lower",
                       stat_changes=[{"stat": "special_defense", "change": -1}],
                       stat_chance=10),
    "mud-slap": _mv("mud-slap", "ground", "special", 20, 100, 10,
                    flags=("protect",), kind="damage+lower",
